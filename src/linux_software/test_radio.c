...
void print_benchmark(volatile unsigned int *periph_base)
{
	...
	unsigned int bytes_transferred = 2; 
	float time_spentflt = (float)stop_time - (float)start_time;
    float time_spent = time_spentflt * .000000008; 
	throughput = ((float)bytes_transferred / time_spent) / 1000000; 
...
// first, get a pointer to the peripheral base address using /dev/mem and the function mmap
    ...
    printf("\r\n\r\n\r\nLab 10 Yesenia Ponce - Custom Peripheral Demonstration\n\r");
